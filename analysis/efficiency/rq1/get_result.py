...
if __name__ == "__main__":
    csv_path = "result.csv"
    main_result_folder = "output/rq1"
    new_result_folder = "output/optimizer_rank_sub_files"
    SEED_RANGE = range(101, 131)
    MAX_RANK = 32

    ranking_csv = "output/rq1_ranking_results.csv"
    ranking_with_cat_csv = "output/rq1_ranking_with_categories.csv"
    optimizer_rank_csv = "output/rq1_optimizer_rank_by_domain_with_category.csv"
    category_summary_csv = "output/rq1_optimizer_category_rank_summary.csv"
